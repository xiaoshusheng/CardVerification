...
public class ValidateUtil {
	...
	/** 企业执行代码 */
	private static final String V_ID_COMPANY ="^[0-9A-HJ-NPQRTUWXY]{2}\\d{6}[0-9A-HJ-NPQRTUWXY]{10}$";
	 ...
	 * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 */
	public static boolean IDcompany(String value){
		return match(V_ID_COMPANY,value);
	}
	public static boolean IDcompany15(String value){
		String regex = "^\\d{15}$";
	 ...
	 * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 */
	public static boolean IDBankcard(String value){
		String regex = "^([1-9]{1})(\\d{15,22})$";
		return match(regex,value);
	}
	...
	public static boolean isPrice(String price) {
		String regex = "^(0|[1-9][0-9]{0,7})(\\.\\d{1,2})?$";
